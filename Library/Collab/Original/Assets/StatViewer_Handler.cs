...
public class StatViewer_Handler : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (RoundProfile != null)
        {
            ...
            RoundHours.text = RoundProfile.TimeSeconds.ToString(DigitFormat_Time);
            RoundMinutes.text = RoundProfile.TimeMinutes.ToString(DigitFormat_Time);
            RoundSeconds.text = RoundProfile.TimeHours.ToString(DigitFormat_Time);
        }
